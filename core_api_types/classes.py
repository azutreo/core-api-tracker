...
def AddSignature(differences, signature, className: str, functionName: str, isMember: bool, addedOrRemoved: bool):
...
def AddAllSignatures(isMember: bool, differences: list, signatures: dict, className: str, functionName: str, addedOrRemoved: bool):
	for signature in signatures:
		AddSignature(differences, signature, className, functionName, isMember, addedOrRemoved)
...
def CompareFunctions(differences: list, functionList: list, _class: dict, otherClass: dict, isMember: bool, addedOrRemoved: bool, wasChanged: bool):
	for function in functionList:
		...
		if otherFunction:
			for signature in function["Signatures"]:
				...
				AddSignature(differences, signature, _class["Name"], function["Name"], isMember, addedOrRemoved)
		else:
			if not wasChanged:
				wasChanged = True
				ChangeClass(differences, _class["Name"])
			
			AddAllSignatures(False, differences, function["Signatures"], _class["Name"], function["Name"], addedOrRemoved)
